...
class HorarioResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('carreara_id')
                    ->numeric()
                    ->default(null),
                ...
                Forms\Components\TextInput::make('aula_id')
                    ->numeric()
                    ->default(null),
                Forms\Components\TextInput::make('sade_id')
                    ->numeric()
                    ->default(null),
                Forms\Components\TextInput::make('anio_lecticvo_id')
                    ->numeric()
                    ->default(null),
            ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('carreara_id')
                    ->numeric()
                    ->sortable(),
                ...
                Tables\Columns\TextColumn::make('aula_id')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('sade_id')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('anio_lecticvo_id')
                    ->numeric()
                    ->sortable(),
